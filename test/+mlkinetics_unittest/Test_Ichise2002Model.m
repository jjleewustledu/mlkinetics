classdef Test_Ichise2002Model < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_TZ3108_build_multinest(this)
            ...
            % fqfn = fullfile( ...
            %     "/Volumes/T7 Shield/TZ3108/sub-cheech/ses-20230131/chemistry", ...
            %     "sub-cheech_ses-20230131_pkin-recalib2.kmData.xls");
            % fqfn = fullfile( ...
            %     "/Volumes/T7 Shield/TZ3108/sub-cheech/ses-20230301/chemistry", ...
            %     "sub-cheech_ses-20230301_pkin-recalib2.kmData.xls");
            fqfn = fullfile( ...
                "/Volumes/T7 Shield/TZ3108/sub-ollie/ses-20230516/chemistry", ...
