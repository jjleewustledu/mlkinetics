classdef Test_Ichise2002Model < matlab.unittest.TestCase
    ...
    properties
        testObj
        torontoDir = "/Users/jjlee/Documents/PapersMine/PapersInProgress/Will_Tu/SNMMI Toronto 2024"
    end
    ...
    methods (Test)
        ...
        function test_TZ3108_build_multinest(this)
            % fqfn = fullfile(this.torontoDir, ...
            %     "sub-lou/ses-20230406/chemistry", ...
            %     "sub-lou_ses-20230406_pkin-recalib2.kmData.xls");
            % fqfn = fullfile(this.torontoDir, ...
            %     "sub-bud/ses-20140724/chemistry", ...
            %     "sub-bud_ses-20140724_pkin.kmData.xls");
            % fqfn = fullfile(this.torontoDir, ...
            %     "sub-cheech/ses-20230131/chemistry", ...
            %     "sub-cheech_ses-20230131_pkin-recalib2.kmData.xls");
            % fqfn = fullfile(this.torontoDir, ...
            %     "sub-cheech/ses-20230301/chemistry", ...
            %     "sub-cheech_ses-20230301_pkin-recalib2.kmData.xls");
            fqfn = fullfile(this.torontoDir, ...
                "sub-ollie/ses-20230516/chemistry", ...
                "sub-ollie_ses-20230516_pkin-recalib2.kmData.xls");
