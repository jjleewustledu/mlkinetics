    ...
    methods (Test)
        ...
        function test_Martin1987Model(this)
            ...
            this.sk = ScannerKit.create( ...
                bids_kit=this.bk, tracer_kit=this.tk, scanner_tags="vision");
        ...
        function test_Mintun1984Model(this)
            ...
            this.rk = RepresentationKit.create( ...
                representation_tags="trivial");   
            this.pk = ParcKit.create( ...
                bids_kit=this.bk, representation_kit=this.rk, parc_tags="wmparc-select-all");
    ...
    methods (TestClassSetup)
        function setupModel(this)
            ...
            this.co_ic = mlfourd.ImagingContext2( ...
                fullfile(this.enclavePetDir, "sub-108293_ses-20210421144815_trc-oc_proc-dyn_pet_ScannerKit_do_make_activity_density_on_T1w.nii.gz"));
            ...
            this.oo_ic = mlfourd.ImagingContext2( ...
                fullfile(this.enclavePetDir, "sub-108293_ses-20210421154248_trc-oo_proc-dyn_pet_ScannerKit_do_make_activity_density_on_T1w.nii.gz"));
            ...
            this.ho_ic = mlfourd.ImagingContext2( ...
                fullfile(this.enclavePetDir, "sub-108293_ses-20210421152358_trc-ho_proc-dyn_pet_ScannerKit_do_make_activity_density_on_T1w.nii.gz"));
            ...
            this.oef_ic = mlfourd.ImagingContext2( ...
                fullfile(this.enclavePetDir, "sub-108293_ses-20210421154248_oef_proc-dyn_pet_on_T1w_voxels.nii.gz"));
            this.cmro2_ic = mlfourd.ImagingContext2( ...
                fullfile(this.enclavePetDir, "sub-108293_ses-20210421150523_cmro2-umol_proc-dyn_pet_on_T1w_voxels.nii.gz"));
            this.raichleks_ic = mlfourd.ImagingContext2( ...
                fullfile(this.enclavePetDir, "sub-108293_ses-20210421152358_raichleks_proc-dyn_pet_on_T1w_voxels.nii.gz"));
