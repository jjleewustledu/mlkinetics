classdef Test_BidsKit < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_create3(this)
            SHOME = getenv("SINGULARITY_HOME");
            fqfn = fullfile(SHOME, ...
                "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421152358', "pet", ...
                "sub-10f8293_ses-20210421152358_trc-ho_proc-BrainMoCo2-createNiftiMovingAvgFrames.nii.gz");
            bk = mlkinetics.BidsKit.create( ...
                bids_tags="ccir1211-ho", bids_fqfn=fqfn);
            med = bk.make_bids_med();
            bids = med.bids;
            this.verifyEqual(bids.pet_dyn_toglob, ...
                fullfile(SHOME, "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421152358', "pet", ...
                "sub-*_ses-*_trc-*_proc-*MovingAvg*_pet.nii.gz"))
            this.verifyEqual(bids.pet_static_toglob, ...
                fullfile(SHOME, "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421152358', "pet", ...
                "sub-*_ses-*_trc-*_proc-*tatic*_pet.nii.gz"))
            this.verifyEqual(bids.anatPath, ...
                fullfile(SHOME, "CCIR_01211", "derivatives", "sub-108293", 'ses-20210218', "anat"))
            this.verifyEqual(bids.originationPath, ...
                fullfile(SHOME, "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421152358', "pet"))
            this.verifyEqual(bids.destinationPath, ...
                fullfile(SHOME, "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421152358', "pet"))
            this.verifyEqual(bids.petPath, ...
                fullfile(SHOME, "CCIR_01211", "derivatives", "sub-108293", 'ses-20210421', "pet"))
            this.verifyEqual(bids.sessionFolderForAnat, "ses-20210218")
            this.verifyEqual(bids.sessionFolderForPet, "ses-20210421152358")
        end
        function test_create4(this)
            SHOME = getenv("SINGULARITY_HOME");
            fqfn = fullfile(SHOME, ...
            ...
            this.verifyEqual(bids.anatPath, ...
                fullfile(SHOME, "CCIR_01211", "derivatives", "sub-108293", 'ses-20210218', "anat"))
            this.verifyEqual(bids.originationPath, ...
                fullfile(SHOME, "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421', "pet"))
            this.verifyEqual(bids.destinationPath, ...
                fullfile(SHOME, "CCIR_01211", "sourcedata", "sub-108293", 'ses-20210421', "pet"))
            this.verifyEqual(bids.petPath, ...
                fullfile(SHOME, "CCIR_01211", "derivatives", "sub-108293", 'ses-20210421', "pet"))
            this.verifyEqual(bids.sessionFolderForAnat, "ses-20210218")
            this.verifyEqual(bids.sessionFolderForPet, "ses-20210421")
        end
