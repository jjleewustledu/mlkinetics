classdef Test_InputFuncKit < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_twilite_device_activity_density_from_tags(this)
            pth = "/Users/jjlee/Singularity/CCIR_01211/sourcedata/sub-108306/ses-20230227/pet";
            cd(pth)
            mg = mglob(fullfile(pth, "sub-*_ses-*_Water1_Dynamic-13.nii.gz"));
            reg = mlvg.Ccir1211Registry.instance();
            reg.tracer = "HO";
            crv_fqfn = fullfile(getenv("HOME"), ...
                "Documents", "CCIRRadMeasurements", "Twilite", "CRV", "o15_dt20230227.crv");
            ifk = mlkinetics.InputFuncKit.create_from_tags( ...
                bids_fqfn=mg(1), ...   
                bids_tags="ccir1211", ...
                tracer_tags="HO", ...
