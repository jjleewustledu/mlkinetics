classdef Test_KineticsKit < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_do_make_2tcm(this)
            fqfn_ = fullfile(getenv("SINGULARITY_HOME"), "TZ3108", "sourcedata", "sub-cheech", "ses-20230131", "pet", ...
        ...
        function test_do_make_patlak(this)
            ...
            h = kit.do_make_plots();
            saveFigure2(h, fullfile(getenv("SINGULARITY_HOME"), "TZ3108", "derivatives", "sub-cheech", "ses-20230131", "pet", ...
