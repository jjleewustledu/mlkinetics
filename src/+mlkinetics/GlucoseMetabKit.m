classdef (Sealed) GlucoseMetabKit < handle & mlkinetics.KineticsKit
    %% GLUCOSEMETABKIT is a concrete factory from an abstract factory design pattern.
    %  
    %  Created 09-Jun-2022 14:27:53 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlkinetics/src/+mlkinetics.
    ...
    methods (Static)
        function this = instance(varargin)
            ...
            if (isempty(uniqueInstance))
                this = mlkinetics.GlucoseMetabKit();
                uniqueInstance = this;
            else
                this = uniqueInstance;
            end
